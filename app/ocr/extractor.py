...
detects whether the document is a passport or NIC, routes to the appropriate
parser, and returns a unified ExtractedFields Pydantic model.
"""
...
def detect_document_type(text_blocks: list[dict]) -> DocumentType:
    ...
    # 1. Explicit keyword match (most reliable)
